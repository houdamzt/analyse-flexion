...
# --- Constantes ---
BETA_CONFLIT = 10  # seuil de conflit (°)
...
# --- Interface utilisateur : Style clair et bien structuré ---
st.title("🦴 Analyse Clinique de la Réserve de Flexion")

col1, col2 = st.columns(2)

with col1:
    st.subheader("📋 Paramètres anatomiques")
...
with col2:
    st.subheader("📐 Cinématique pelvienne")
    ...
    gamma = st.slider("Abduction (γ °)", min_value=0.0, max_value=30.0, step=1.0, value=0.0)
