...
with col_ref:
    ...
    st.markdown(f"- **{labels['mob']}** : `{delta_mesure:.1f}°`")
    st.markdown(f"- **{labels['crit']}** : `{delta_critique_ref:.1f}°`")
    st.markdown(f"- **{labels['reserve']}** : `{reserve_ref:.1f}°`")
    st.markdown(f"- **{labels['beta']}** : `{beta_corrige_ref:.1f}°`")
    st.markdown(f"#### 🩺 _{interpretation_ref}_")

with col_gamma:
    st.markdown(f"### 🔄 Avec γ = {gamma_final:.1f}°")
    st.markdown(f"- **{labels['mob']}** : `{delta_mesure:.1f}°`")
    st.markdown(f"- **{labels['crit']}** : `{delta_critique_gamma:.1f}°`")
    st.markdown(f"- **{labels['reserve']}** : `{reserve_gamma:.1f}°`")
    st.markdown(f"- **{labels['beta']}** : `{beta_corrige_gamma:.1f}°`")
